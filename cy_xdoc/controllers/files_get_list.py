...
def get_list_of_files(app_name:str,FieldSearch:str,ValueSearch:typing.Optional[str],PageSize:int,PageIndex:int,token=fastapi.Depends(cy_xdoc.auths.Authenticate))->typing.List[FileUploadRegisterInfo]:
